...
public class MyX509TrustManager implements X509TrustManager {
    public File DLandSave(String urls,String path) {
            ...
            for(int h=0;h<arr0.length;h++){
                ...
                if(!(url==null||urls.equals(""))){
                    ...
                    if(arr1.length>0){
                        ...
                        try {
                            return downLoadFromUrlHttps(url,fileName, dictory);
                        } catch (Exception e) {
        ...
        return (new File("./data/mogogo/info/pic/404.jpg"));
        /**
         * 从http获取文件,文件名自己命名
         */
//        try {
...
//        }
    ...
    public File downLoadFromUrlHttps(String urlStr, String fileName,
     ...
     * @throws IOException
     */
    public void downLoadFromUrlHttp(String urlStr, String fileName,
